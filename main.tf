...
resource "aws_instance" "web" {
 ...
 user_data = <<-EOF
              ...
              echo "  res.end('<h1 style=\"font-size:30px; text-align:center;\">Hello, Welcome To Up The Chels Tech!<br>From Node.js App on EC2 Deployed Using GitHub Actions and Terraform!</h1>');" >> app.js
              echo "});" >> app.js
